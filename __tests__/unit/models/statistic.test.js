...
describe('Statistic model', () => {
  ...
  describe('Save', () => {
    describe('with valid data', () => {
      it('should be saved successfully', () => {
        ...
        expect(stat.userId.toString()).to.equal(user._id.toString())
      })
    ...
    describe('with invalid data', () => {
      ...
      it('with missing icon, then should fail', async () => {
        ...
        expect(err).to.exist
        expect(err).to.be.instanceOf(ValidationError)
        expect(err.errors.icon).to.exist
      })

      it('with missing userId, then should fail', async () => {
        let err
        statData.userId = undefined
  ...
  describe('Find', () => {
    it('should be found successfully', async () => {
      const found = await Statistic.findOne({ _id: new ObjectId(stat._id) })
    ...
    it('should find by userId', async () => {
      const found = await Statistic.find({ userId: new ObjectId(user._id) })
